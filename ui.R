  ...
  ui <- bootstrapPage(
    ...
    background-color: transparent;",
                                 ...
                                 div(class = "main-content",
                                     ...
                                     h3(uiOutput("acces_refuse")),
                                     h4(textOutput("text_village_selected")),
                                     shinycssloaders::withSpinner(
                                       plotlyOutput("result_map_click", height = "80%"),
                                   ...
                                   column(12, linebreaks(1),
                                          div(class = "parametres-container",
                                              shinyWidgets::pickerInput("indicateurs","Indicateurs à visualiser",
                                                                        choices = c("Démographie de la communauté des pêcheurs",
                                                                                    "Proportions de pêcheurs enquêtés par filières halieutiques",
                                                                                    "Proportions de pêcheurs enquêtés par techniques de pêches",
                                                                                    "Autres ressources de mangrove exploitées"),
                                                                        multiple = FALSE,selected = "Démographie de la communauté des pêcheurs",width = '100%')
                                          )
                                   )
                                 )
                   ),
